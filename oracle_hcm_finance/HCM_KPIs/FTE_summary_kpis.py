...
total_employees, filtered_data_count, terminated_employees, category_counts, category_and_termination_counts, other_category_count, other_category_blank_termination_count = count_employees_by_joining_date(file_path, year=2024, month=None, quarter=None)
