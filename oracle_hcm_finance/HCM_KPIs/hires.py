    ...
    try:
        ...
        if 'Date of Joining' in csv_data.columns:
            ...
            if month == 'all':
                ...
                for m in range(1, 11):  # Iterate over months 1 to 12
                    month_data = csv_data[csv_data['Date of Joining'].dt.year == year]
                    month_data = month_data[month_data['Date of Joining'].dt.month == m]
                ...
                month_data = csv_data[(csv_data['Date of Joining'].dt.year == year) &
                                      (csv_data['Date of Joining'].dt.month == month)]
...
# Example usage
hires(1)  # Count of new joiners for January 2024
hires('all')  # Count of new joiners for all months in 2024
